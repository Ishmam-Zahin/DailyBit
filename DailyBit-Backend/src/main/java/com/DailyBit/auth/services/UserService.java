...
public class UserService {
    ...
    private User convertToUser(UserCreateDTO requestUserDTO) {
        User user = new User();
    ...
    public void addNormalUser(UserCreateDTO requestUserDTO, MultipartFile imageFile) throws IOException, CustomException {
